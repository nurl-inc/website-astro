...
- **We care deeply about safety.** Our dedicated Trust & Safety team works hard to help keep our community safe. We also use certain information to help us identify violations of our [Community Guidelines](./community-guidelines) and prevent harmful content from being distributed through the services.
...
<strong class={css({ textDecoration: 'underline' })}>
...
- **To protect our services.** We use information to keep our services secure, to prevent misuse, and to enforce our [Terms of Service](./terms) and [other policies](./other) against users who violate them.
...
<strong class={css({ textDecoration: 'underline' })}>With your consent</strong>
...
- **To enforce our policies and rights.** We may disclose information if needed to enforce our [Terms of Service](./terms), [Community Guidelines](./community-guidelines), or [other policies](./other), or to protect the rights, property, and safety of ourselves and others.
...
We retain personal information until we determine it is no longer needed for the processing purposes for which we collected or retain it or for legal compliance. You can learn more about data retention periods in our [data retention policy](./how-long-we-keep-your-data).
...
You can disable or delete your account via the User Settings menu. Disabling your account stops the processing of new data, but allows you to reactivate your account without interruption to you. Deleting your account permanently deletes identifying information and anonymizes other data as described in our [data retention policy](./how-long-we-keep-your-data). You can learn more about how to delete your account by visiting our [Help Center](https://discord.gg/eJJhW6b).
...
Content may be retained by Nurl for use as described elsewhere in this policy and in our [data retention policy](./how-long-we-keep-your-data). Also, in limited circumstances, we may have a legal obligation to retain certain information, even if you delete the information or your account.

**Access your information**

If you want to see what information we have collected about you, you can request a copy of your data in the Privacy & Safety section of your User Settings. You should receive your data packet within 30 days. Data is delivered in common digital formats including CSV, JSON, and any other file format you used when uploading attachments to the services. You can learn more about how to access your information [in our Help Center](https://discord.gg/eJJhW6b).
...
If you have questions or complaints regarding our compliance with the Privacy Shield principles, please reach out to us at privacy@nurl.app. If we do not resolve your complaint, you may submit your complaint free of charge to [JAMS](https://www.jamsadr.com/eu-us-privacy-shield). Under certain conditions specified by the Privacy Shield principles, you may also be able to invoke binding arbitration to resolve your complaint. We are subject to the investigatory and enforcement powers of the U.S. Federal Trade Commission. In certain circumstances, we may be liable for the transfer of personal data from the EU, Switzerland, or the UK to a third party outside those countries.
...
You can contact Nurl Netherlands BV’s Data Protection Officer at dpo@nurl.app.
...
We retain personal information as described in the “Data retention” section above and in our [data retention policy](./how-long-we-keep-your-data).

**Requests received:** please see [this page](./data-reporting-metrics) for information on the number of data requests we have received.
